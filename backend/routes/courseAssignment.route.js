...
/**
 * @swagger
 * /api/timetable/course/{courseCode}:
 *   get:
 *     summary: Get timetable for a specific course across all active sections
 *     tags: [Course Assignments]
 */
router.get('/course/:courseCode', verifyUser, getCourseTimetable);
